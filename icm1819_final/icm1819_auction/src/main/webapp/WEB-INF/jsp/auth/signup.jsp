            ...
            <div class="form-container">
                ...
                <form>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="fullname" name="fullname" value="" placeholder="Name">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="username" name="username" value="" placeholder="Chose a username">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <button type="submit" class="form-submit primary-button">Sign Up</button>
                </form>
            </div>
        </div>
    </div>
